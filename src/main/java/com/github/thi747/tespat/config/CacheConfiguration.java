...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.github.thi747.tespat.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.github.thi747.tespat.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, com.github.thi747.tespat.domain.User.class.getName());
