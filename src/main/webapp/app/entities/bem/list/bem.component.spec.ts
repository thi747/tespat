...
import { sampleWithRequiredData } from '../bem.test-samples';
import { BemService } from '../service/bem.service';

import { BemComponent } from './bem.component';
import SpyInstance = jest.SpyInstance;

describe('Bem Management Component', () => {
  let comp: BemComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'bem', component: BemComponent }]), HttpClientTestingModule, BemComponent],
      providers: [
        {
