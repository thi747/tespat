...
import { EntityArrayResponseType, BemService } from '../service/bem.service';
import { BemDeleteDialogComponent } from '../delete/bem-delete-dialog.component';
...
export class BemComponent implements OnInit {
  ...
  delete(bem: IBem): void {
    const modalRef = this.modalService.open(BemDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.bem = bem;
  ...
  protected fillComponentAttributesFromResponseBody(data: IBem[] | null): IBem[] {
    return data ?? [];
  }
